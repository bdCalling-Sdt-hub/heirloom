...
import 'package:heirloom/utils/app_icons.dart'; // Custom colors
  ...
  List<Map<String, String>> messages = [
    {
      'sender': 'ai',
      'message':
          'Hey Jamil, you are back! I am excited to learn more about you.'
    },
    ...
    {'sender': 'ai', 'message': 'Childhood.'},
    {
      'sender': 'user',
      'message':
          'Got it. You can type a message and tell me something about your childhood.'
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(FontAwesomeIcons.arrowUpRightFromSquare, color: Colors.white,size: 16.h,),
            onPressed: () {},
          ),
        ],
      ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  InkWell(
                      onTap:(){},
                      child: Image.asset(AppIcons.image,height: 30.h,)),
                  SizedBox(width: 5.w,),
                  Expanded(
                  ...
                  InkWell(
                      onTap: _sendMessage,
                      child: Image.asset(AppIcons.send,height: 30.h,)),
                ],
              ),
            ),
          ],
