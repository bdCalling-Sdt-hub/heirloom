...
import 'package:heirloom/Controller/notification/notification_controller.dart';
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          padding: EdgeInsets.symmetric(
              horizontal: 20.w, vertical: Platform.isIOS ? 0 : 10.h),
          child: ClipRRect(
              ...
              child: BottomNavigationBar(
                ...
                unselectedItemColor:
                    Colors.white.withOpacity(0.6), // Dim inactive icons
                selectedFontSize: 0,
                unselectedFontSize: 0,
                items: [
                  BottomNavigationBarItem(
                    icon: Image.asset(AppIcons.home, width: 28.w, height: 28.h),
                    activeIcon: Image.asset(AppIcons.homeFill,
                        width: 30.w, height: 30.h),
                    label: '',
                  ),
                  BottomNavigationBarItem(
                    icon:
                        Image.asset(AppIcons.aiChat, width: 28.w, height: 28.h),
                    activeIcon: Image.asset(AppIcons.aiChatFill,
                        width: 28.w, height: 28.h),
                    label: '',
                  ),
                  BottomNavigationBarItem(
                    icon: Image.asset(AppIcons.relation,
                        width: 28.w, height: 28.h),
                    activeIcon: Image.asset(AppIcons.relationFill,
                        width: 28.w, height: 28.h),
                    label: '',
                  ),
                  BottomNavigationBarItem(
                    icon: Image.asset(AppIcons.profile,
                        width: 28.w, height: 28.h),
                    activeIcon: Image.asset(AppIcons.profileFill,
                        width: 28.w, height: 28.h),
                    label: '',
                  ),
                ],
